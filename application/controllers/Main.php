...
//                 unset($data2['format']);
//
//                 if (!$this->base_model->get_data('karjoo', '*', array('mobile' => $data->mobile))) {
//                     $user_id            = $this->base_model->insert('karjoo', $data);
...
//                 $this->base_model->update('karjoo', array('mobile' => $data->mobile), array('code' => $data2['code']));
//
//             }
//
//             if ($data2)
...
//     }
//
//     function send_notify($user_id, $sms)
//     {
//         $code    = rand(1000, 9999);
...
//             if ($this->base_model->get_data('karjoo', '*', array('mobile' => $data->mobile, 'code' => $data->code))) {
//
//
//                 $data3['status'] = 1;
//                 $this->base_model->update('karjoo', array('mobile' => $data->mobile), $data3);
//                 //unset($_SESSION['register_code']);
//                 $res = array("user_active" => true);
//
//                 $user = $this->db->get_where("karjoo", array(
//                     "mobile" => $data->mobile,
//                     "code"   => $data->code
//                 ))->result_array();
//
