    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="<?php echo base_url("ui/dashboard"); ?>">
                <img src="<?php echo base_url() ?>assets/logo-1.svg" alt="logo" class="logo-default"
                     width="120px" style="margin-top:19px;"/> </a>
    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false"
                ...
                <?php if (true): ?>
                    <li class="nav-item start" id="m-manage-resellers">
                ...
                <?php if (true): ?>
                    <li class="nav-item start" id="m-manage-orders">
                        <a href="<?php echo base_url('ui/orders/index'); ?>" class="nav-link ">
                ...
                <?php if (true): ?>
                    <li class="nav-item start" id="m-comments">
